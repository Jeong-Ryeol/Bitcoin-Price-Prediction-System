...
Price Direction 분포:
- UP: 1,267/8,412 = 15.1%
- DOWN: 1,210/8,412 = 14.4%
- STABLE: 5,935/8,412 = 70.6%
```
...
전체 데이터의 엔트로피:
```
P(UP) = 1267/8412 = 0.151
P(DOWN) = 1210/8412 = 0.144
P(STABLE) = 5935/8412 = 0.706

H(전체) = -[0.151×log₂(0.151) + 0.144×log₂(0.144) + 0.706×log₂(0.706)]
        = -[-0.381 - 0.387 - 0.274]
        = 1.042 bits
```
...
정보 이득 = H(전체) - [P(golden)×H(golden) + P(dead)×H(dead) + P(neutral)×H(neutral)]
          = 1.042 - [(4334/8412)×1.164 + (4057/8412)×1.089 + (21/8412)×0.454]
          = 1.042 - 0.801
          = 0.241 bits
```
